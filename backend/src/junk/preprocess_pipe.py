...
def process_waves(wav_rest, fwav):
...
def save_result():
    ...
    with open(output_filename, "a") as output:
        ...
        filenames = [name for name in all_files if os.path.isfile(os.path.join(data_dir, name))]
        ...
        for idx, filename in enumerate(filenames):
            ...
            wav_rest, fwav = process_waves(wav_rest, fwav)
